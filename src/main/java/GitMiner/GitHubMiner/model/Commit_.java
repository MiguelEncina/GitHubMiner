...
public class Commit_ {
    ...
    public Commit_(String id, String title, String message,
    ...
    public String toString() {
        ...
        sb.append(Commit_.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
